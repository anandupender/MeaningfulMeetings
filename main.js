...
function startKeyboard(){
    document.addEventListener('keyup', event => {
        switch(event.code) {
            ...
            // show a cool gif
            case "KeyG":
                window.open("https://giphy.com/explore/random");
                break;

            // show random TED talk 
            case "KeyT":
                window.open("https://www.youtube.com/teded/videos?view=0&sort=p&flow=grid");
                break;
        }
    })
